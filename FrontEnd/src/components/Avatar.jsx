...
export const Avatar = ({ externalMessage }) => {
  ...
  /**
   * Handle received media tracks from WebRTC.
   * @param {RTCTrackEvent} event - Event containing the media track.
   */
  ...
  /**
   * Handle the result of speech recognition and synthesize a response.
   * @param {string} userQuery - The recognized user query.
   */
  ...
  /**
   * Handle microphone button click to start/stop speech recognition.
   */
